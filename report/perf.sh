...
parse_output()
{
    sed "s/$/,$option_cdcl,$option_adjacency,$option_clause,$option_decision,$is_sat/"
}

echo "value,?1,counter,?2,?3,ratio,?5,cdcl,adjacency,clause,decision,sat"
...
do
    ...
    do
        ...
        do
            perf stat -x, -e instructions,L1-dcache-loads,L1-dcache-load-misses,branches,branch-misses,page-faults \
