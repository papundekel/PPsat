...
void PPsat::help_print(std::ostream& out)
{
    out << "Description:\n"
        ...
        << "\n"
        << "Options:\n"
        << "\t-help [<BOOL>]\t\t\t\t\tDisplays this help if true (default: "
           "false).\n"
        << "\t-subprogram [convert|solve]\t\t\tSubprogram selection (default: "
           "solve).\n"
        << "\t-nnf [<BOOL>]\t\t\t\t\tWhether the input is in NNF (default: "
           "false).\n"
        << "\t-format [dimacs|smtlib]\t\t\t\tUse the specified format for the "
           "input (default: smtlib for convert, dimacs for solve).\n"
        << "\t-clause [basic|counting|watched_literals]\tThe type of data "
           "structure for unit propagation (default: watched_literals).\n"
        << "\t-adjacency [list|set|set_unordered]\t\tThe type of data "
           "structure for literal adjacency (default: set_unordered).\n"
        << "\t-decision [trivial|random|JW_static|VSIDS]\tThe type of "
           "decision heuristic (default: JW_static).\n"
        ...
        << "\t-cdcl [<BOOL>]\t\t\t\t\tUse the CDCL version of the solver (as "
           "opposed "
           "to DPLL) if true. (default: false).\n"
        << "\t-assume [<BOOL>]\t\t\t\tAccept an assumption if true (default: "
           "false).\n"
        << "\n"
        << "Subprograms:\n"
        << "\tconvert\tConverts SMT-LIB into DIMACS using the tseiting "
           "encoding.\n"
        << "\t\tThe default input format is SMT-LIB.\n"
        << "\tsolve\tThe solver.\n"
        << "\t\tThe default input format is DIMACS.\n"
        << "\n"
        << "Clause structures:\n"
